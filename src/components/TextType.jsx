...
const TextType = ({
  ...
  useEffect(() => {
    ...
    const executeTypingAnimation = () => {
      if (isDeleting) {
        ...
        // Fix: Ensure we reach the full length including the last character
  ...
  }, [currentCharIndex, displayedText, isDeleting, typingSpeed, deletingSpeed, pauseDuration, textArray, currentTextIndex, loop, isVisible]);
